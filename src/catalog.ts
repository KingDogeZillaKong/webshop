...
export const ALL_PRODUCTS : ProductModel[] = [getProduct(234, "Security Tooling", 36999.99, react),getProduct(345, "Blockchain Analysis", 19999.00 , DEFAULT_IMAGE), getProduct(678, "Personal Web App", 19999.00 , angular),getProduct(789, "Poker Software", 49999.00 , angular),getProduct(468, "Developer Portal", 49999.00 , next), getProduct(890, "Learning Management System", 49999.00 , next), getProduct(246, "E-commerce", 49999.00 , DEFAULT_IMAGE)];
